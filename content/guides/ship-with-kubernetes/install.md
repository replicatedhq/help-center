...
![Customers](/images/guides/kubernetes/customers.png)
...
[CHANGE SCREENSHOT]![Create Customer](/images/guides/kubernetes/create-customer.png)
...
![Installation Methods](/images/guides/kubernetes/installation-methods.png)
...
![Console TLS](/images/guides/kubernetes/admin-console-tls.png) [CHANGE THIS SCREENSHOT]
...
![Upload License](/images/guides/kubernetes/upload-license.png)  [CHANGE THIS SCREENSHOT]

The settings page is here with default configuration items. These can be specified in the `config.yaml` file.

![Settings Page](/images/guides/kubernetes/configuration.png) [CHANGE THIS SCREENSHOT]
...
![Cluster](/images/guides/kubernetes/application.png)
