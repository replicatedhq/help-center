...
The schema is published as a [JSONSchema V4](http://json-schema.org/documentation.html) 
document in the [Replicated Lint Repository](https://github.com/replicatedhq/replicated-lint/blob/master/src/schemas/parsed.ts)

The canonical source for all available Replicated YAML options is available at 
...
The following list documents rules that will be applied by the [Replicated 
release editor](https://vendor.replicated.com/releases) and the
[replicated-lint cli](https://npmjs.com/package/replicated-lint).


<!-- 

The rest of this page is autogenerated! Changes should be made in https://github.com/replicatedhq/replicated-lint, see the README 
in that repo for instructions on how to update this document 
